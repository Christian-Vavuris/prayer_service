  ...
  return (
    <div className="py-8 max-w-md">
      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed" style={{ color: "var(--muted-text)" }}>
        ...
        <p>
          Every request submitted here is read and offered in prayer by a human being — spoken aloud, and brought before God. Prayers are offered every Sunday, with urgent requests prioritized.
        </p>
      </div>
    </div>
  );
